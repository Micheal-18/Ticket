...
const Footer = () => {
    return (
        <footer className='sticky flex flex-col justify-center items-center  w-full h-[20vh]'>
            <div className='flex flex-col md:flex-row items-center justify-between border-t-2 border-gray-400 w-full max-w-6xl mb-8 mt-8 pt-6'>
                {/* Links */}
