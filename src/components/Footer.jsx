        ...
        <footer className='sticky flex flex-col items-center justify-center mx-auto w-full h-[100%]'>
            <div className='lg:flex items-center justify-between border-t-2 border-gray-400 w-full mb-8 mt-8 pt-6 px-4 '>
                <div className='flex justify-center flex-col mb-4 '>
                    <h1 className='text-2xl font-bold text-gray-800'>Airticks<span className='text-orange-500'>.Events</span></h1>
                    <p className='text-sm text-gray-600'>Plan. Create. Enjoy.</p>
                ...
                <div className='flex flex-col space-y-4'>
                    {/* Links */}
                    <div className='flex lg:flex-row flex-col gap-6 text-gray-600 text-sm uppercase'>
