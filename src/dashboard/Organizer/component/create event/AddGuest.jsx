      ...
      <div className='flex justify-between items-center'>
        <div>
          ...
          <p className='text-xs font-light opacity-70'>
            DJs, Speakers, Hosts, Guests, Performers...
          </p>
        </div>
        <button
          type='button'
      ...
      {guests.map(guest => (
        ...
        >
          ...
          <input
            ...
            className='w-full rounded-xl  border border-(--border) p-4 focus:outline-(--primary)'
          />
          ...
          <div>
            ...
            <select
              ...
              className='mt-2 w-full rounded-xl  border border-(--border) p-4 focus:outline-(--primary)'
            >
          ...
          {guest.role === 'Other' && (
            <div>
              ...
              <input
                ...
                onChange={e =>
                  updateGuest(guest.id, 'customRole', e.target.value)
                }
                className='mt-2 w-full rounded-xl  border border-(--border) p-4 focus:outline-(--primary)'
              />
            </div>
          ...
          <div>
            ...
            <input
              ...
              className='w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file: border border-(--border)-0 file:text-sm file:font-semibold file:bg-orange-50 file:text-(--primary) hover:file:bg-orange-100 cursor-pointer'
            />
          </div>
