...
const OrgProfile = () => {
  ...
  // Save Name, Bio, and Avatar modifications
  ...
  return (
    <div className="w-full flex justify-center items-center p-4 md:p-8">
      <div className="flex flex-col bg-(--bg-color) p-6 rounded-xl shadow-md w-full max-w-2xl border border-gray-100 dark:border-gray-800 max-h-[85vh] overflow-y-auto custom-scrollbar">
        
        <h1 className="text-xl font-bold mb-6 uppercase tracking-wider">Organizer Profile</h1>

        {/* Tab Selection Row */}
        <div className="flex gap-2 shadow p-2 mb-6 text-sm font-medium rounded-lg">
          <button 
            type="button"
            ...
            <div>
              {isEditing ? (
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="text-xs font-bold uppercase tracking-wider text-gray-400">Biography / Info</label>
                    <textarea
                      name="bio"
                      rows="4"
                ...
                <div className="space-y-4">
                  <div className="bg-(--bg-color)/40 p-4 rounded-xl space-y-3.5">
                    <div>
                      ...
                      <p className="font-semibold mt-0.5">{profileData.fullName || "Unnamed Organizer"}</p>
                    </div>
                    ...
                    <div>
                      <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Organizer Bio</p>
                      <p className="text-sm font-medium mt-0.5 text-gray-600 dark:text-gray-300 whitespace-pre-line">{profileData.bio || "No biography added yet."}</p>
                    </div>
                  </div>
