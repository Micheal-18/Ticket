...
const Profile = () => {
  ...
  // Save Name, Phone, Bio, and Avatar modifications
  ...
  return (
    <div className="w-full flex justify-center items-center p-4 md:p-8">
      <div className="flex flex-col bg-(--bg-color) dark:bg-(--bg-color) text-(--text-color) dark:text-(--text-color) p-6 rounded-xl shadow-md w-full max-w-2xl border border-gray-100 dark:border-gray-800 max-h-[85vh] overflow-y-auto custom-scrollbar">
        
        <h1 className="text-xl font-bold mb-6 uppercase tracking-wider">Account Profile</h1>

        {/* Tab Selection Row */}
        <div className="flex gap-2 shadow p-2 mb-6 text-sm font-medium border-b dark:border-gray-800">
          <button 
            type="button"
                ...
                <div className="space-y-4">
                  <div className="bg-(--bg-color)/40 p-4 rounded-xl space-y-3.5">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium mt-0.5 text-gray-600 dark:text-gray-300 whitespace-pre-line">{profileData.bio || "No bio set"}</p>
                    </div>
                  </div>
